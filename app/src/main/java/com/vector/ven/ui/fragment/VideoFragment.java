...
public class VideoFragment extends BaseFragment implements View.OnClickListener{
    ...
    class ViewHolder{
        @Bind(R.id.progress_bar)NumberProgressBar mProgressBar;
        @Bind(R.id.cur_length)TextView mCurLength;
        @Bind(R.id.content_length)TextView mContentLength;
        @Bind(R.id.download_btn)Button mDownloadBtn;
